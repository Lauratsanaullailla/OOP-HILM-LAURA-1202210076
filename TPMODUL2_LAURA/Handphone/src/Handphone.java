public class Handphone extends Perangkat{
    ...
    public void informasi(){
        if(this.fingerprint == true){
            System.out.print("Handphone ini memiliki drive tipe "+ drive + " dengan ram sebesar " +ram +" dan processor " + "secepat " +processor+" Ghz. Selain itu juga laptop ini memiliki Fingerprint");
        }
        else{
